...
export interface NodePin {
  name: string;
  /** HCL type string, e.g. "string", "list(object)" */
  type: string;
  /** inputs only; always false for outputs */
  required: boolean;
  /** input has an Out binding, or output feeds >=1 edge */
  wired: boolean;
  description: string;
  /** outputs only */
  sensitive: boolean;
  ...
  fromJSON(object: any): CopyInstancesRequest {
    return {
      instance_ids: globalThis.Array.isArray(object?.instanceIds)
        ...
        : globalThis.Array.isArray(object?.instance_ids)
        ? object.instance_ids.map((e: any) => globalThis.String(e))
        : [],
    };
  },
...
export const RenderNode: MessageFns<RenderNode> = {
  encode(message: RenderNode, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.inputs) {
      NodePin.encode(v!, writer.uint32(74).fork()).join();
    }
    for (const v of message.outputs) {
      NodePin.encode(v!, writer.uint32(82).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 9: {
          ...
          message.inputs.push(NodePin.decode(reader, reader.uint32()));
          continue;
        }
        case 10: {
          if (tag !== 82) {
          ...
          message.outputs.push(NodePin.decode(reader, reader.uint32()));
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): RenderNode {
    return {
      ...
      error_messages: globalThis.Array.isArray(object?.errorMessages)
        ...
        : [],
      inputs: globalThis.Array.isArray(object?.inputs) ? object.inputs.map((e: any) => NodePin.fromJSON(e)) : [],
      outputs: globalThis.Array.isArray(object?.outputs) ? object.outputs.map((e: any) => NodePin.fromJSON(e)) : [],
    };
  },
  ...
  toJSON(message: RenderNode): unknown {
    ...
    if (message.inputs?.length) {
      obj.inputs = message.inputs.map((e) => NodePin.toJSON(e));
    }
    if (message.outputs?.length) {
      obj.outputs = message.outputs.map((e) => NodePin.toJSON(e));
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<RenderNode>, I>>(object: I): RenderNode {
    ...
    message.inputs = object.inputs?.map((e) => NodePin.fromPartial(e)) || [];
    message.outputs = object.outputs?.map((e) => NodePin.fromPartial(e)) || [];
    return message;
  },
};

function createBaseNodePin(): NodePin {
  return { name: "", type: "", required: false, wired: false, description: "", sensitive: false };
}

export const NodePin: MessageFns<NodePin> = {
  encode(message: NodePin, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    if (message.type !== "") {
    ...
    if (message.wired !== false) {
      writer.uint32(32).bool(message.wired);
    }
    if (message.description !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): NodePin {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseNodePin();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): NodePin {
    return {
      name: isSet(object.name) ? globalThis.String(object.name) : "",
      type: isSet(object.type) ? globalThis.String(object.type) : "",
      required: isSet(object.required) ? globalThis.Boolean(object.required) : false,
      wired: isSet(object.wired) ? globalThis.Boolean(object.wired) : false,
      description: isSet(object.description) ? globalThis.String(object.description) : "",
      sensitive: isSet(object.sensitive) ? globalThis.Boolean(object.sensitive) : false,
    };
  },

  toJSON(message: NodePin): unknown {
    const obj: any = {};
    if (message.name !== "") {
      obj.name = message.name;
    }
  ...
  create<I extends Exact<DeepPartial<NodePin>, I>>(base?: I): NodePin {
    return NodePin.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<NodePin>, I>>(object: I): NodePin {
    const message = createBaseNodePin();
    message.name = object.name ?? "";
    message.type = object.type ?? "";
    message.required = object.required ?? false;
    message.wired = object.wired ?? false;
    message.description = object.description ?? "";
    message.sensitive = object.sensitive ?? false;
    return message;
  },
...
export const LaceEngineService = {
  ...
  copyInstances: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: CopyInstancesRequest): Buffer => Buffer.from(CopyInstancesRequest.encode(value).finish()),
