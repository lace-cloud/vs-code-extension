...
const CARD_SIZE = 28; // px — the visual card is a fixed square
      ...
      <div className="absolute top-full left-1/2 -translate-x-1/2 mt-1 flex flex-col items-center pointer-events-auto">
        {editing ? (
          <input
            ...
            onBlur={commitRename}
            onKeyDown={onKeyDown}
            className="bg-[#161616] text-[#CEFE65] border border-[rgba(206,254,101,0.2)] rounded px-1 py-px text-[8px] text-center w-24"
            onClick={(e) => e.stopPropagation()}
          />
        ) : (
          <span
            className="text-[8px] text-[#CEFE65] opacity-80 whitespace-nowrap max-w-[80px] truncate"
